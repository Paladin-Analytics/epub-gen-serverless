// Generated by CoffeeScript 2.3.2 but has direct changes, recompiling index.legacy.coffee will replace them
(function() {
    ...
    EPub = class EPub {
        ...
        generateTempFile() {
            ...
            _.each(this.options.content, function(content) {
                var data;
                data = `${self.options.docHeader}\n  <head>\n  <meta charset="UTF-8" />\n  <title>${entities.encodeXML(content.title.replace(/[^[a-z]\s]/gi, '') || content.filename.replace(/[^[a-z]\s]/gi, ''))}</title>\n  <link rel="stylesheet" type="text/css" href="style.css" />\n  </head>\n<body>`;
